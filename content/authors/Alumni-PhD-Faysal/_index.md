...
external_link: "https://fhshezan.github.io/"
...
# Role/position
role: PhD grad in 2023, now AP of UT Arlington

# Organizations/Affiliations
organizations:
  - name: University of Texas, Arlington
    url: 'https://fhshezan.github.io/'
...
social:
  - icon: envelope
    icon_pack: fas
    link: 'faysal.shezan@uta.edu'
  - icon: twitter
    icon_pack: fab
    link: https://x.com/faysalhossain07/with_replies
  - icon: google-scholar
    icon_pack: ai
    link: https://scholar.google.com/citations?user=h2h3PMEAAAAJ&hl=en
  - icon: github
    icon_pack: fab
