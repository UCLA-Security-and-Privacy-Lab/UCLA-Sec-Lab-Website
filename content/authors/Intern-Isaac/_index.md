---
title: Isaac Khabra # Here is your name to display on the website

first_name: Isaac # Your first name
last_name: Khabra # Your last name
...
social:
  - icon: envelope
    icon_pack: fas
    link: 'isaackhabra@ucla.edu'
# Link to a PDF of your resume/CV from the About widget.
# To enable, copy your resume/CV to `static/files/cv.pdf` and uncomment the lines below.
  - icon: cv
    icon_pack: ai
    link: https://github.com/isaackhabra

# Enter email to display Gravatar (if Gravatar enabled in Config)
email: 'isaackhabra@ucla.edu'
